...
const Mobile = ({click, setClick}) => {
  return (
      <div className={`bg-[#F0F0F0] transition-all ease-in-out duration-500 ${click ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-[200%]'} lgg:hidden absolute top-20 -left-0 text-black z-30 px-4 py-8 w-[250px] h-screen`}>
